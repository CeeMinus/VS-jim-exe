...
HXLINE( 142)		{
HXLINE( 142)			 ::flixel::math::FlxPoint _g = this->offset;
HXDLIN( 142)			_g->set_x((_g->x - ( (Float)(13) )));
            		}
HXLINE( 143)		{
HXLINE( 143)			 ::flixel::math::FlxPoint _g1 = this->offset;
HXDLIN( 143)			_g1->set_y((_g1->y - ( (Float)(13) )));
            		}
            	}
