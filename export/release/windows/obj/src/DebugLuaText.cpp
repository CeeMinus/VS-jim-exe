...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1364_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1364,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1376_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1376,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1364_new)
HXLINE(1366)		this->disableTime = ((Float)6);
HXLINE(1369)		this->parentGroup = parentGroup;
HXLINE(1370)		super::__construct(10,10,0,text,16,null());
HXLINE(1371)		this->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1372)		this->scrollFactor->set(null(),null());
HXLINE(1373)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1376_update)
HXLINE(1377)		this->super::update(elapsed);
HXLINE(1378)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1378)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1379)		if ((this->disableTime <= 0)) {
HXLINE(1380)			this->kill();
HXLINE(1381)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1382)			this->destroy();
            		}
            		else {
HXLINE(1384)			if ((this->disableTime < 1)) {
HXLINE(1384)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
