...
HXLINE( 196)				{
HXLINE( 196)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 196)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05)) * ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ))));
            				}
HXLINE( 197)				if (::PlayState_obj::isPixelStage) {
HXLINE( 198)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 198)					_g->set_y((_g->y * ((Float)1.19)));
            				}
HXLINE( 200)				prevNote->updateHitbox();
            			}
HXLINE( 204)			if (::PlayState_obj::isPixelStage) {
HXLINE( 205)				{
HXLINE( 205)					 ::flixel::math::FlxPoint _g = this->scale;
HXDLIN( 205)					_g->set_y((_g->y * ::PlayState_obj::daPixelZoom));
            				}
...
HXLINE( 211)		{
HXLINE( 211)			 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 211)			_g2->set_x((_g2->x + this->offsetX));
            		}
            	}
