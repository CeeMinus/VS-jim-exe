...
HXLINE( 581)								if (::hx::IsEq( this->grpInputsAlt->__get(i).StaticCast<  ::AttachedText >()->sprTracker,item )) {
...
HXLINE( 588)								if (::hx::IsEq( this->grpInputs->__get(i).StaticCast<  ::AttachedText >()->sprTracker,item )) {
...
HXLINE( 603)				if (::hx::IsEq( this->grpInputs->__get(i).StaticCast<  ::AttachedText >()->sprTracker,Dynamic( this->grpOptions->members->__get(::ControlsSubstate_obj::curSelected)).StaticCast<  ::Alphabet >() )) {
...
HXLINE( 612)				if (::hx::IsEq( this->grpInputsAlt->__get(i).StaticCast<  ::AttachedText >()->sprTracker,Dynamic( this->grpOptions->members->__get(::ControlsSubstate_obj::curSelected)).StaticCast<  ::Alphabet >() )) {
...
HXLINE( 684)								if (::hx::IsEq( this->grpInputsAlt->__get(i).StaticCast<  ::AttachedText >()->sprTracker,item )) {
...
HXLINE( 690)								if (::hx::IsEq( this->grpInputs->__get(i).StaticCast<  ::AttachedText >()->sprTracker,item )) {
