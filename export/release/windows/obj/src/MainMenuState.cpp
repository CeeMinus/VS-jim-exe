...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_140_giveAchievement,"MainMenuState","giveAchievement",0x39ddd809,"MainMenuState.giveAchievement","MainMenuState.hx",140,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_242_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",242,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_150_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",150,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_195_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",195,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_201_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",201,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_256_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",256,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_247_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",247,0x0e5db805)
...
HXLINE( 147)		this->selectedSomethin = false;
HXLINE(  34)		this->optionShit = ::Array_obj< ::String >::fromData( _hx_array_data_205e8859_1,6);
...
HXLINE(  49)		{
HXLINE(  49)			 ::flixel::FlxCamera _hx_tmp = this->camAchievement;
HXDLIN(  49)			_hx_tmp->bgColor = (_hx_tmp->bgColor & 16777215);
HXDLIN(  49)			 ::flixel::FlxCamera _hx_tmp1 = this->camAchievement;
HXDLIN(  49)			_hx_tmp1->bgColor = (_hx_tmp1->bgColor | 0);
            		}
HXLINE(  51)		::flixel::FlxG_obj::cameras->reset(this->camGame);
HXLINE(  52)		::flixel::FlxG_obj::cameras->add(this->camAchievement,null()).StaticCast<  ::flixel::FlxCamera >();
HXLINE(  53)		::flixel::FlxCamera_obj::_defaultCameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,this->camGame);
...
HXLINE(  60)		Float yScroll = ::Math_obj::max((((Float)0.25) - (((Float)0.05) * ( (Float)((this->optionShit->length - 4)) ))),((Float)0.1));
HXLINE(  61)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  61)		::String library = null();
HXDLIN(  61)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("menuBG",24,65,6d,05));
HXDLIN(  61)		 ::Dynamic bg1;
HXDLIN(  61)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  61)			bg1 = imageToReturn;
            		}
            		else {
HXLINE(  61)			bg1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBG",24,65,6d,05)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN(  61)		 ::flixel::FlxSprite bg2 = bg->loadGraphic(bg1,null(),null(),null(),null(),null());
HXLINE(  62)		bg2->scrollFactor->set(0,yScroll);
HXLINE(  63)		bg2->setGraphicSize(::Std_obj::_hx_int((bg2->get_width() * ((Float)1.175))),null());
...
HXLINE(  69)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
...
HXLINE(  76)		 ::flixel::FlxSprite _hx_tmp4 = this->magenta;
HXDLIN(  76)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  77)		this->magenta->updateHitbox();
HXLINE(  78)		this->magenta->screenCenter(null());
HXLINE(  79)		this->magenta->set_visible(false);
HXLINE(  80)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
...
HXLINE(  90)				Float offset = (( (Float)(108) ) - ((::Math_obj::max(( (Float)(this->optionShit->length) ),( (Float)(4) )) - ( (Float)(4) )) * ( (Float)(80) )));
HXLINE(  91)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,((i * 140) + offset),null());
HXLINE(  92)				::String key = (HX_("mainmenu/menu_",a9,7b,4b,27) + this->optionShit->__get(i));
HXDLIN(  92)				::String library = null();
HXDLIN(  92)				 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
HXDLIN(  92)				bool xmlExists = false;
HXDLIN(  92)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE(  92)					xmlExists = true;
            				}
HXDLIN(  92)				 ::Dynamic _hx_tmp;
HXDLIN(  92)				if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  92)					_hx_tmp = imageLoaded;
            				}
            				else {
HXLINE(  92)					 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN(  92)					if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  92)						_hx_tmp = imageToReturn;
            					}
            					else {
HXLINE(  92)						_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            					}
            				}
HXDLIN(  92)				::String _hx_tmp1;
HXDLIN(  92)				if (xmlExists) {
HXLINE(  92)					_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE(  92)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            				}
HXDLIN(  92)				menuItem->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
...
HXLINE(  96)				menuItem->ID = i;
HXLINE(  97)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  98)				this->menuItems->add(menuItem).StaticCast<  ::flixel::FlxSprite >();
HXLINE(  99)				Float scr = (( (Float)((this->optionShit->length - 4)) ) * ((Float)0.135));
HXLINE( 100)				if ((this->optionShit->length < 6)) {
HXLINE( 100)					scr = ( (Float)(0) );
            				}
HXLINE( 101)				menuItem->scrollFactor->set(0,scr);
HXLINE( 102)				menuItem->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 104)				menuItem->updateHitbox();
            			}
            		}
HXLINE( 107)		::flixel::FlxG_obj::camera->follow(this->camFollowPos,null(),1);
HXLINE( 109)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 44),0,(HX_("Psych Engine v",5d,a0,37,c7) + ::MainMenuState_obj::psychEngineVersion),12,null());
HXLINE( 110)		versionShit->scrollFactor->set(null(),null());
HXLINE( 111)		versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 112)		this->add(versionShit);
HXLINE( 113)		int versionShit1 = (::flixel::FlxG_obj::height - 24);
HXDLIN( 113)		 ::flixel::text::FlxText versionShit2 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,versionShit1,0,(HX_("Friday Night Funkin' v",03,65,b0,2f) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c))),12,null());
HXLINE( 114)		versionShit2->scrollFactor->set(null(),null());
HXLINE( 115)		versionShit2->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 116)		this->add(versionShit2);
HXLINE( 120)		this->changeItem(null());
HXLINE( 123)		::Achievements_obj::loadAchievements();
HXLINE( 124)		 ::Date leDate = ::Date_obj::now();
HXLINE( 125)		bool _hx_tmp5;
HXDLIN( 125)		if ((leDate->getDay() == 5)) {
HXLINE( 125)			_hx_tmp5 = (leDate->getHours() >= 18);
            		}
            		else {
HXLINE( 125)			_hx_tmp5 = false;
            		}
HXDLIN( 125)		if (_hx_tmp5) {
HXLINE( 126)			int achieveID = ::Achievements_obj::getAchievementIndex(HX_("friday_night_play",9b,1f,4e,c7));
HXLINE( 127)			if (!(::Achievements_obj::isAchievementUnlocked(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) )))) {
HXLINE( 128)				::Achievements_obj::achievementsMap->set(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) ),true);
HXLINE( 129)				this->giveAchievement();
...
void MainMenuState_obj::giveAchievement(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_140_giveAchievement)
HXLINE( 141)		this->add( ::AchievementObject_obj::__alloc( HX_CTX ,HX_("friday_night_play",9b,1f,4e,c7),this->camAchievement));
HXLINE( 142)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 142)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
HXLINE( 143)		::haxe::Log_obj::trace(HX_("Giving achievement \"friday_night_play\"",e6,1b,7d,1f),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),143,HX_("MainMenuState",59,88,5e,20),HX_("giveAchievement",1e,ea,83,24)));
            	}
...
void MainMenuState_obj::update(Float elapsed){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_242_update)
HXLINE( 242)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_150_update)
HXLINE( 149)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 151)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 153)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 153)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 156)		Float lerpVal = ::CoolUtil_obj::boundTo((elapsed * ((Float)5.6)),( (Float)(0) ),( (Float)(1) ));
HXLINE( 157)		Float a = this->camFollowPos->x;
HXDLIN( 157)		Float a1 = this->camFollowPos->y;
HXDLIN( 157)		this->camFollowPos->setPosition((a + (lerpVal * (this->camFollow->x - a))),(a1 + (lerpVal * (this->camFollow->y - a1))));
HXLINE( 159)		if (!(this->selectedSomethin)) {
HXLINE( 161)			if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
...
HXLINE( 167)			if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
...
HXLINE( 170)				this->changeItem(1);
            			}
HXLINE( 173)			if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 175)				this->selectedSomethin = true;
...
HXLINE( 177)				::MusicBeatState_obj::switchState( ::TitleState_obj::__alloc( HX_CTX ,null(),null()));
            			}
HXLINE( 180)			if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 182)				if ((this->optionShit->__get(::MainMenuState_obj::curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 184)					::CoolUtil_obj::browserLoad(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92));
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::MainMenuState,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::FlxSprite spr){
            						HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_195_update)
HXLINE( 195)						if ((::MainMenuState_obj::curSelected != spr->ID)) {
            							HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxSprite,spr) HXARGC(1)
            							void _hx_run( ::flixel::tweens::FlxTween twn){
            								HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_201_update)
HXLINE( 201)								spr->kill();
            							}
            							HX_END_LOCAL_FUNC1((void))

HXLINE( 197)							::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 209)								::String daChoice = _gthis->optionShit->__get(::MainMenuState_obj::curSelected);
HXLINE( 211)								::String _hx_switch_0 = daChoice;
            								if (  (_hx_switch_0==HX_("awards",b6,92,c1,8d)) ){
HXLINE( 218)									::MusicBeatState_obj::switchState( ::AchievementsMenuState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 218)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("credits",1a,0e,5e,13)) ){
HXLINE( 220)									::MusicBeatState_obj::switchState( ::CreditsState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 220)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 216)									::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 216)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 222)									::MusicBeatState_obj::switchState( ::OptionsState_obj::__alloc( HX_CTX ,null(),null()));
HXDLIN( 222)									goto _hx_goto_5;
            								}
            								if (  (_hx_switch_0==HX_("story_mode",2d,63,e6,a4)) ){
HXLINE( 214)									::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 207)							::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 189)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 191)					if (::ClientPrefs_obj::flashing) {
HXLINE( 191)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 193)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            				}
            			}
            			else {
HXLINE( 230)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 230)				if (_this->keyManager->checkStatus(55,_this->status)) {
HXLINE( 232)					this->selectedSomethin = true;
HXLINE( 233)					::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
            				}
            			}
            		}
HXLINE( 238)		this->super::update(elapsed);
HXLINE( 240)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_256_changeItem)
HXLINE( 257)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 258)			spr->offset->set_y(( (Float)(0) ));
HXLINE( 259)			spr->updateHitbox();
HXLINE( 261)			if ((spr->ID == ::MainMenuState_obj::curSelected)) {
HXLINE( 263)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 264)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 264)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 264)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
HXLINE( 265)				spr->offset->set_x((((Float)0.15) * ((( (Float)(spr->frameWidth) ) / ( (Float)(2) )) + 180)));
HXLINE( 266)				spr->offset->set_y((((Float)0.15) * ( (Float)(spr->frameHeight) )));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_247_changeItem)
HXLINE( 246)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 248)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::MainMenuState >();
HXDLIN( 248)		::MainMenuState_obj::curSelected = (::MainMenuState_obj::curSelected + huh);
HXLINE( 250)		if ((::MainMenuState_obj::curSelected >= this->menuItems->length)) {
HXLINE( 251)			::MainMenuState_obj::curSelected = 0;
            		}
HXLINE( 252)		if ((::MainMenuState_obj::curSelected < 0)) {
HXLINE( 253)			::MainMenuState_obj::curSelected = (this->menuItems->length - 1);
            		}
...
HXDLIN(  27)		psychEngineVersion = HX_("0.4.2",3a,46,cb,c1);
            	}
{
